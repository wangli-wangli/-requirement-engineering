...
<% 
	...
	/*  String user_Email="1@qq.com"; */
		UserDaoImpl userDao = new UserDaoImpl();
		platform platform=userDao.load_basic2(user_Email);
		...
		<table align="center" border="1px" background="image/123.jpg"
			...
			<tr>
				...
				<td bgcolor="white" width="30%"><input type="text" size="50"
					name="platform_name" id="platform_name" value="<%=platform.getPlatform_name()%>"
					readonly="readonly" /></td>
				<td bgcolor="white" width="20%">平台编号</td>
				<td bgcolor="white" width="30%"><input type="text" size="50"
					name="authorize_date" value="<%=platform.getPlatform_number()%>" id="authorize_date"
					readonly="readonly" /></td>
			</tr>
			<tr>
				<td bgcolor="white">批准年月</td>
				<td bgcolor="white"><input type="text" size="50" value="<%=authorize.getAuthorize_date() %>"
					name="authorize_date" value=""
					id="authorize_date" readonly="readonly" /></td>
				<td bgcolor="white">批准文号</td>
				<td bgcolor="white"><input type="text" size="50"
					name="authorize_number" value="<%=authorize.getAuthorize_number()%>"
					id="authorize_number" readonly="readonly"></td>
			</tr>
			<tr>
				<td bgcolor="white">技术领域</td>
				<td bgcolor="white" colspan="3"><input type="text" size="115"
					name="technology_field" value="<%=platform.getTechnology_field()%>"
					id="technology_field" readonly="readonly" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td bgcolor="white" colspan="3"><ol>
						<li><input type="text" value="" name="user_unit"
							+0+"" id="user_unit" +0+"" size="70" /><input type="button"
							id="btn2" value="添加" /></li>
					</ol></td>
			</tr>
		</table>
